...
/*! Разделяет входную строку на токены, соединенные в строке одним или несколькими белыми разделителями.
...
/*! Преобразует входную строку выражения, записанного в виде постфиксной (обратной польской) записи, в строку выражения в формате TeX
